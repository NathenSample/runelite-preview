...
namespace EveOPreview
{
	...
	{
		private const string EXCEPTION_DUMP_FILE_NAME = "Runelite Preview.log";
		private const string EXCEPTION_MESSAGE = "Runelite Preview has encountered a problem and needs to close. Additional information has been saved in the crash log file.";
		...
		private void ExceptionEventHandler(Exception exception)
		{
			try
			{
				...
				MessageBox.Show(ExceptionHandler.EXCEPTION_MESSAGE, @"Runelite Preview", MessageBoxButtons.OK, MessageBoxIcon.Error);
			}
			catch
			{
